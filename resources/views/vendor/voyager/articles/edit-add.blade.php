    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $('button.save[type=submit]').on('click',function(e){
                ...
                if($('input[type=checkbox][name=top_second]').prop('checked')){
                    $.ajax({
                        method: 'get',
                        data: {
                            article_id: {{ $dataTypeContent->id }}
                        },
                          url: "/set_top_second_article",
                          success(data) {
                            console.log(data);
                          },
                        });
                }
                if($('input[type=checkbox][name=top_third]').prop('checked')){
                    $.ajax({
                        method: 'get',
                        data: {
                            article_id: {{ $dataTypeContent->id }}
                        },
                          url: "/set_top_third_article",
                          success(data) {
                            console.log(data);
                          },
                        });
